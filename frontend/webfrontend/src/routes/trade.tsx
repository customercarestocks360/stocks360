                ...
                {topVolume.map((a) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <FavoriteStar id={`stock:${a.t}`} />
                      <div className="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-secondary border border-border">
                        <span className="font-mono text-[9px] font-bold text-foreground truncate max-w-[28px]">{a.t}</span>
                      </div>
